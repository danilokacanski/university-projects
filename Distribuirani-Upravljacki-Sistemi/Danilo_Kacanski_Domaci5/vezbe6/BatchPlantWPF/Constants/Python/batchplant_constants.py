...
class BrowseNames(Enum):
    ...
    Pump = "PumpX001"
    PumpMotor = "Pump01"
    PumpMotorType = "PumpMotorType"
    PumpTemperatureSensor = "PumpTemperatureSensor01"
    PumpType = "PumpType"
    Silo1 = "SiloX001"
...
class MethodIds(Enum):
    ...
    BatchPlantType_TurnOnPump = "nsu=http://opcfoundation.org/BatchPlant;i=546"
    BatchPlantType_TurnOffPump = "nsu=http://opcfoundation.org/BatchPlant;i=547"
    ...
    BatchPlant1_TurnOnPump = "nsu=http://opcfoundation.org/BatchPlant;i=548"
    BatchPlant1_TurnOffPump = "nsu=http://opcfoundation.org/BatchPlant;i=549"
...
class ObjectIds(Enum):
    ...
    PumpType_PumpMotor = "nsu=http://opcfoundation.org/BatchPlant;i=424"
    PumpType_PumpTemperatureSensor = "nsu=http://opcfoundation.org/BatchPlant;i=500"
    ...
    BatchPlantType_Pump = "nsu=http://opcfoundation.org/BatchPlant;i=438"
    BatchPlantType_Pump_PumpMotor = "nsu=http://opcfoundation.org/BatchPlant;i=439"
    BatchPlantType_Pump_PumpTemperatureSensor = "nsu=http://opcfoundation.org/BatchPlant;i=514"
    ...
    BatchPlant1_Pump = "nsu=http://opcfoundation.org/BatchPlant;i=453"
    BatchPlant1_Pump_PumpMotor = "nsu=http://opcfoundation.org/BatchPlant;i=454"
    BatchPlant1_Pump_PumpTemperatureSensor = "nsu=http://opcfoundation.org/BatchPlant;i=528"
...
class ObjectTypeIds(Enum):
    ...
    TemperatureType = "nsu=http://opcfoundation.org/BatchPlant;i=493"
    ...
    PumpMotorType = "nsu=http://opcfoundation.org/BatchPlant;i=416"
    ...
    PumpType = "nsu=http://opcfoundation.org/BatchPlant;i=423"
...
class VariableIds(Enum):
    ...
    TemperatureType_Temperature = "nsu=http://opcfoundation.org/BatchPlant;i=494"
    TemperatureType_Temperature_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=498"
    PumpMotorType_State = "nsu=http://opcfoundation.org/BatchPlant;i=542"
    ...
    PumpType_PumpMotor_Speed = "nsu=http://opcfoundation.org/BatchPlant;i=425"
    PumpType_PumpMotor_Speed_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=429"
    PumpType_PumpMotor_State = "nsu=http://opcfoundation.org/BatchPlant;i=543"
    PumpType_PumpTemperatureSensor_Output = "nsu=http://opcfoundation.org/BatchPlant;i=501"
    PumpType_PumpTemperatureSensor_Output_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=505"
    PumpType_PumpTemperatureSensor_Units = "nsu=http://opcfoundation.org/BatchPlant;i=507"
    PumpType_PumpTemperatureSensor_Temperature = "nsu=http://opcfoundation.org/BatchPlant;i=508"
    PumpType_PumpTemperatureSensor_Temperature_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=512"
    ...
    BatchPlantType_Pump_PumpMotor_Speed = "nsu=http://opcfoundation.org/BatchPlant;i=440"
    BatchPlantType_Pump_PumpMotor_Speed_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=444"
    BatchPlantType_Pump_PumpMotor_State = "nsu=http://opcfoundation.org/BatchPlant;i=544"
    BatchPlantType_Pump_PumpTemperatureSensor_Output = "nsu=http://opcfoundation.org/BatchPlant;i=515"
    BatchPlantType_Pump_PumpTemperatureSensor_Output_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=519"
    BatchPlantType_Pump_PumpTemperatureSensor_Units = "nsu=http://opcfoundation.org/BatchPlant;i=521"
    BatchPlantType_Pump_PumpTemperatureSensor_Temperature = "nsu=http://opcfoundation.org/BatchPlant;i=522"
    BatchPlantType_Pump_PumpTemperatureSensor_Temperature_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=526"
    ...
    BatchPlant1_Pump_PumpMotor_Speed = "nsu=http://opcfoundation.org/BatchPlant;i=455"
    BatchPlant1_Pump_PumpMotor_Speed_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=459"
    BatchPlant1_Pump_PumpMotor_State = "nsu=http://opcfoundation.org/BatchPlant;i=545"
    BatchPlant1_Pump_PumpTemperatureSensor_Output = "nsu=http://opcfoundation.org/BatchPlant;i=529"
    BatchPlant1_Pump_PumpTemperatureSensor_Output_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=533"
    BatchPlant1_Pump_PumpTemperatureSensor_Units = "nsu=http://opcfoundation.org/BatchPlant;i=535"
    BatchPlant1_Pump_PumpTemperatureSensor_Temperature = "nsu=http://opcfoundation.org/BatchPlant;i=536"
    BatchPlant1_Pump_PumpTemperatureSensor_Temperature_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=540"
