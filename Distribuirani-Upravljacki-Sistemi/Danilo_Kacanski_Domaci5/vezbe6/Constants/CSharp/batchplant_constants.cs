namespace BatchPlant.WebApi
{
    ...
    public static class VariableIds {
        ...
        /// <remarks />
        public const string PumpMotorType_Temperature = "nsu=" + Namespaces.Uri + ";i=417";
        /// <remarks />
        public const string PumpMotorType_Temperature_EURange = "nsu=" + Namespaces.Uri + ";i=421";
        /// <remarks />
        ...
        /// <remarks />
        public const string PumpType_PumpMotor_Temperature = "nsu=" + Namespaces.Uri + ";i=431";
        /// <remarks />
        public const string PumpType_PumpMotor_Temperature_EURange = "nsu=" + Namespaces.Uri + ";i=435";
        /// <remarks />
        public const string PumpType_State = "nsu=" + Namespaces.Uri + ";i=437";
        /// <remarks />
        ...
        /// <remarks />
        public const string BatchPlantType_Pump_PumpMotor_Temperature = "nsu=" + Namespaces.Uri + ";i=446";
        /// <remarks />
        public const string BatchPlantType_Pump_PumpMotor_Temperature_EURange = "nsu=" + Namespaces.Uri + ";i=450";
        /// <remarks />
        public const string BatchPlantType_Pump_State = "nsu=" + Namespaces.Uri + ";i=452";
        /// <remarks />
        ...
        /// <remarks />
        public const string BatchPlant1_Pump_PumpMotor_Temperature = "nsu=" + Namespaces.Uri + ";i=461";
        /// <remarks />
        public const string BatchPlant1_Pump_PumpMotor_Temperature_EURange = "nsu=" + Namespaces.Uri + ";i=465";
        /// <remarks />
        public const string BatchPlant1_Pump_State = "nsu=" + Namespaces.Uri + ";i=467";
