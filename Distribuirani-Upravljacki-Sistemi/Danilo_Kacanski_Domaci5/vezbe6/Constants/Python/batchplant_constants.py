...
class VariableIds(Enum):
    ...
    PumpMotorType_Temperature = "nsu=http://opcfoundation.org/BatchPlant;i=417"
    PumpMotorType_Temperature_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=421"
    ...
    PumpType_PumpMotor_Temperature = "nsu=http://opcfoundation.org/BatchPlant;i=431"
    PumpType_PumpMotor_Temperature_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=435"
    PumpType_State = "nsu=http://opcfoundation.org/BatchPlant;i=437"
    ...
    BatchPlantType_Pump_PumpMotor_Temperature = "nsu=http://opcfoundation.org/BatchPlant;i=446"
    BatchPlantType_Pump_PumpMotor_Temperature_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=450"
    BatchPlantType_Pump_State = "nsu=http://opcfoundation.org/BatchPlant;i=452"
    ...
    BatchPlant1_Pump_PumpMotor_Temperature = "nsu=http://opcfoundation.org/BatchPlant;i=461"
    BatchPlant1_Pump_PumpMotor_Temperature_EURange = "nsu=http://opcfoundation.org/BatchPlant;i=465"
    BatchPlant1_Pump_State = "nsu=http://opcfoundation.org/BatchPlant;i=467"
